<template>
  <div class="latex-editor">
    <div class="container">
      <div class="left">
        <div class="input-area">
          <TextArea v-model:value="latex" placeholder="輸入 LaTeX 公式" ref="textAreaRef" />
        </div>
        <div class="preview">
          <div class="placeholder" v-if="!latex">公式預覽</div>
    ...
    <div class="footer">
      ...
      <Button class="btn" type="primary" @click="update()">確定</Button>
    </div>
  </div>
</template>
...
const tabs: TabItem[] = [
  { label: '常用符號', key: 'symbol' },
  { label: '預置公式', key: 'formula' },
]
...
const update = () => {
  if (!latex.value) return message.error('公式不能為空')
