<template>
  <div class="element-positopn-panel">
    ...
    <ButtonGroup class="row">
      <Button style="flex: 1;" @click="orderElement(handleElement!, ElementOrderCommands.TOP)"><i-icon-park-outline:send-to-back /> 置頂</Button>
    ...
    <div class="title">對齊：</div>
    <ButtonGroup class="row">
      <Button style="flex: 1;" v-tooltip="'左對齊'" @click="alignElementToCanvas(ElementAlignCommands.LEFT)"><i-icon-park-outline:align-left /></Button>
      ...
      <Button style="flex: 1;" v-tooltip="'右對齊'" @click="alignElementToCanvas(ElementAlignCommands.RIGHT)"><i-icon-park-outline:align-right /></Button>
    </ButtonGroup>
    <ButtonGroup class="row">
      <Button style="flex: 1;" v-tooltip="'上對齊'" @click="alignElementToCanvas(ElementAlignCommands.TOP)"><i-icon-park-outline:align-top /></Button>
      ...
      <Button style="flex: 1;" v-tooltip="'下對齊'" @click="alignElementToCanvas(ElementAlignCommands.BOTTOM)"><i-icon-park-outline:align-bottom /></Button>
    </ButtonGroup>
    ...
    <template v-if="handleElement!.type !== 'line'">
      <div class="row">
        ...
        <template v-if="['image', 'shape', 'audio'].includes(handleElement!.type)">
          <span style="width: 10%;" class="icon-btn" :class="{ 'active': fixedRatio }" v-tooltip="fixedRatio ? '解除寬高比鎖定' : '寬高比鎖定'" @click="updateFixedRatio(!fixedRatio)">
