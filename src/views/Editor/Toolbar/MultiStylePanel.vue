  ...
  <div class="multi-style-panel">
    ...
    <ButtonGroup class="row" passive>
      <Popover trigger="click" style="width: 30%;">
        ...
        <TextColorButton first :color="richTextAttrs.color" v-tooltip="'文字顏色'">
    ...
    >
      <RadioButton value="left" style="flex: 1;" v-tooltip="'左對齊'"><i-icon-park-outline:align-text-left /></RadioButton>
      <RadioButton value="center" style="flex: 1;" v-tooltip="'居中'"><i-icon-park-outline:align-text-center /></RadioButton>
      <RadioButton value="right" style="flex: 1;" v-tooltip="'右對齊'"><i-icon-park-outline:align-text-right /></RadioButton>
      <RadioButton value="justify" style="flex: 1;" v-tooltip="'兩端對齊'"><i-icon-park-outline:align-text-both /></RadioButton>
    </RadioGroup>
  </div>
</template>
