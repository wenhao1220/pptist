...
const defaultFilters: FilterOption[] = [
  ...
  { label: '對比度', key: 'contrast', default: 100, value: 100, unit: '%', max: 200, step: 5 },
  { label: '灰度', key: 'grayscale', default: 0, value: 0, unit: '%', max: 100, step: 5 },
  { label: '飽和度', key: 'saturate', default: 100, value: 100, unit: '%', max: 200, step: 5 },
  ...
  { label: '反轉', key: 'invert', default: 0, value: 0, unit: '%', max: 100, step: 5 },
...
const presetFilters: {
  ...
  { label: '復古', values: { 'sepia': '50%', 'contrast': '110%', 'brightness': '90%' } },
  { label: '銳化', values: { 'contrast': '150%' } },
  ...
  { label: '鮮豔', values: { 'saturate': '200%' } },
  { label: '模糊', values: { 'blur': '2px' } },
  { label: '反轉', values: { 'invert': '100%' } },
]
