<template>
  <div class="viewport-size-setting">
    <div class="title">自定義畫布尺寸</div>
    <div class="row">
      <div class="label">寬度：</div>
      <NumberInput 
    ...
    <div class="tip">寬高範圍：500 ~ 2000</div>
    <div class="btns">
      <Button type="primary" @click="applyCustomViewportSize()">確認</Button>
...
const applyCustomViewportSize = () => {
  ...
  ) return message.warning(`畫布寬高需在 ${VIEWPORT_SIZE_MIN} ~ ${VIEWPORT_SIZE_MAX} 之間`)
