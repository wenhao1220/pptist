  ...
  <div class="slide-design-panel">
    ...
    <div class="row">
      <Select 
        ...
        :options="[
          { label: '純色填充', value: 'solid' },
          { label: '圖片填充', value: 'image' },
          { label: '漸變填充', value: 'gradient' },
        ]"
      />
      ...
      <Select 
        ...
        :options="[
          { label: '縮放', value: 'contain' },
          { label: '拼貼', value: 'repeat' },
          { label: '縮放鋪滿', value: 'cover' },
        ]"
      />
      ...
      <Select 
        ...
        v-else
        :options="[
          { label: '線性漸變', value: 'linear' },
          { label: '徑向漸變', value: 'radial' },
        ]"
      />
    </div>
    ...
    <div class="row">
      <Button style="flex: 1;" @click="applyBackgroundAllSlide()"><i-icon-park-outline:check /> 應用背景到全部</Button>
    </div>
    ...
    <div class="row">
      <Select 
        ...
        :options="[
          { label: '寬屏 16 : 9', value: 0.5625 },
          { label: '寬屏 16 : 10', value: 0.625 },
          { label: '標準 4 : 3', value: 0.75 },
          { label: '紙張 A3 / A4', value: 0.70710678 },
          { label: '豎向 A3 / A4', value: 1.41421356 },
    ...
    <div class="row">
      <div class="canvas-size">畫布尺寸：{{  viewportSize  }} × {{ toFixed(viewportSize * viewportRatio) }}</div>
    </div>
    ...
    <div class="row">
      <Button style="flex: 1;" @click="applyThemeToAllSlides(moreThemeConfigsVisible)"><i-icon-park-outline:check /> 應用主題到全部</Button>
    </div>

    <div class="row">
      <Button style="flex: 1;" @click="applyFontToAllSlides(theme.fontName)"><i-icon-park-outline:check /> 全域性統一字型</Button>
    </div>

    <div class="row">
      <Button style="flex: 1;" @click="themeStylesExtractVisible = true"><i-icon-park-outline:platte /> 從投影片提取主題</Button>
    </div>

    <Divider />

    <div class="title">預置主題</div>
    <div class="theme-list">
      ...
      >
        <div class="theme-item-content">
          ...
          <div class="btns">
            <Button type="primary" size="small" @click="applyPresetTheme(item)">設定</Button>
            <Button type="primary" size="small" style="margin-top: 3px;" @click="applyPresetTheme(item, true)">設定並應用</Button>
          </div>
        </div>
      </div>
    </div>
