  ...
  <div class="table-style-panel">
    ...
    <ButtonGroup class="row" passive>
      <Popover trigger="click" style="width: 50%;">
        ...
        <TextColorButton first v-tooltip="'文字顏色'" :color="textAttrs.color">
      ...
      <Popover trigger="click" style="width: 50%;">
        ...
        <TextColorButton last v-tooltip="'單元格填充'" :color="textAttrs.backcolor">
    ...
    >
      <RadioButton value="left" v-tooltip="'左對齊'" style="flex: 1;"><i-icon-park-outline:align-text-left /></RadioButton>
      <RadioButton value="center" v-tooltip="'居中'" style="flex: 1;"><i-icon-park-outline:align-text-center /></RadioButton>
      <RadioButton value="right" v-tooltip="'右對齊'" style="flex: 1;"><i-icon-park-outline:align-text-right /></RadioButton>
      <RadioButton value="justify" v-tooltip="'兩端對齊'" style="flex: 1;"><i-icon-park-outline:align-text-both /></RadioButton>
    </RadioGroup>
    ...
    >
      <RadioButton value="top" v-tooltip="'頂對齊'" style="flex: 1;"><i-icon-park-outline:align-text-top-one /></RadioButton>
      <RadioButton value="middle" v-tooltip="'垂直居中'" style="flex: 1;"><i-icon-park-outline:align-text-middle-one /></RadioButton>
      <RadioButton value="bottom" v-tooltip="'底對齊'" style="flex: 1;"><i-icon-park-outline:align-text-bottom-one /></RadioButton>
    </RadioGroup>
    ...
    <div class="row">
      ...
      <ButtonGroup style="width: 60%;" passive>
        <Button first style="flex: 1;" @click="emitTableCommand('insert-row', 'after')">新增行</Button>
        <Popover trigger="click">
          <template #content>
            <PopoverMenuItem center @click="emitTableCommand('insert-row', 'before')">上方新增</PopoverMenuItem>
            <PopoverMenuItem center @click="emitTableCommand('insert-row', 'after')">下方新增</PopoverMenuItem>
            <PopoverMenuItem center @click="emitTableCommand('delete-row')">刪除行</PopoverMenuItem>
          </template>
    ...
    <div class="row">
      ...
      <ButtonGroup style="width: 60%;" passive>
        <Button first style="flex: 1;" @click="emitTableCommand('insert-col', 'after')">新增列</Button>
        <Popover trigger="click">
          <template #content>
            <PopoverMenuItem center @click="emitTableCommand('insert-col', 'before')">左側新增</PopoverMenuItem>
            <PopoverMenuItem center @click="emitTableCommand('insert-col', 'after')">右側新增</PopoverMenuItem>
            <PopoverMenuItem center @click="emitTableCommand('delete-col')">刪除列</PopoverMenuItem>
          </template>
          <Button last class="popover-btn"><i-icon-park-outline:down /></Button>
        </Popover>
      </ButtonGroup>
