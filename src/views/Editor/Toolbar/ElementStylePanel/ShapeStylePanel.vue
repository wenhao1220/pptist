  ...
  <div class="shape-style-panel">
    ...
    <div class="row">
      <Select 
        ...
        :options="[
          { label: '純色填充', value: 'fill' },
          { label: '漸變填充', value: 'gradient' },
          { label: '圖片填充', value: 'pattern' },
        ]"
      />
    ...
    <div class="row">
      ...
      ><i-icon-park-outline:format-brush /> 形狀格式刷</CheckboxButton>
    </div>
  </div>
</template>
