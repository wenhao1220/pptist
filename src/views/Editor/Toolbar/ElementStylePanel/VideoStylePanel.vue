<template>
  <div class="video-style-panel">
    ...
    <div class="row">
      <Button style="flex: 1;" @click="setVideoPosterFromFirstFrame()"><i-icon-park-outline:screenshot-one /> 設定首幀為封面</Button>
    </div>
