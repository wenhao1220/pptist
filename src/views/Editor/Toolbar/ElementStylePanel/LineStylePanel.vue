<template>
  <div class="line-style-panel">
    ...
    <div class="row">
      <Button style="flex: 1;" @click="updateLine({ start: handleLineElement.end, end: handleLineElement.start })"><i-icon-park-outline:switch /> 交換方向</Button>
    </div>
