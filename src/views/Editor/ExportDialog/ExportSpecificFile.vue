<template>
  <div class="export-pptist-dialog">
    <div class="configs">
      ...
      <div class="tip">
        提示：.pptist 是本應用的特有檔案字尾，支援將該型別的檔案匯入回應用中。
      </div>
    </div>
    <div class="btns">
      <Button class="btn export" type="primary" @click="exportSpecificFile(selectedSlides)"><i-icon-park-outline:download /> 匯出 PPTIST 檔案</Button>
