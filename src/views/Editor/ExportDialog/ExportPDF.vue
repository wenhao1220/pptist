    ...
    <div class="configs">
      <div class="row">
        ...
        >
          ...
          <RadioButton style="width: 50%;" value="current">當前頁</RadioButton>
        </RadioGroup>
      </div>
      <div class="row">
        <div class="title">每頁數量：</div>
        <Select 
          class="config-item"
          v-model:value="count"
          :options="[
      ...
      <div class="row">
        <div class="title">邊緣留白：</div>
        <div class="config-item">
          <Switch v-model:value="padding" />
        </div>
      </div>
      <div class="tip">
        建議：請在彈出的列印視窗中勾選「背景圖形」選項，邊距選擇「預設」。
      </div>
    </div>

    <div class="btns">
      <Button class="btn export" type="primary" @click="expPDF()"><i-icon-park-outline:download /> 列印 / 匯出 PDF</Button>
