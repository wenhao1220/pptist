    ...
    <Popover trigger="click">
      <template #content>
        <div class="table-command-menu">
          ...
          <PopoverMenuItem center @click="emitTableCommand('insert-col', 'before')">左側插入列</PopoverMenuItem>
          <PopoverMenuItem center @click="emitTableCommand('insert-col', 'after')">右側插入列</PopoverMenuItem>
        </div>
      </template>
      <button class="toolbar-btn">
