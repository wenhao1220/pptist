<template>
  <div class="link-handler" :style="handlerStyle">
    ...
    <a class="link" v-else-if="elementInfo.link" @click="turnTarget(elementInfo.link.target)">投影片頁面 {{elementInfo.link.target}}</a>
    <div class="btns">
      <div class="btn" @click="openLinkDialog()">更換</div>
