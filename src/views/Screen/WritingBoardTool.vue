      ...
      <div class="tools" @mousedown.stop>
        <div class="tool-content">
          <Popover placement="top" trigger="manual" :value="sizePopoverType === 'pen'" @hide="sizePopoverType = ''">
            <template #content>
              <div class="setting">
                <div class="label">墨跡粗細：</div>
                <Slider class="size-slider" :min="4" :max="10" :step="2" v-model:value="penSize" />
              </div>
            </template>
            <div class="btn" :class="{ 'active': writingBoardModel === 'pen' }" v-tooltip="'畫筆'" @click="changeModel('pen')">
          ...
          <Popover placement="top" trigger="manual" :value="sizePopoverType === 'shape'" @hide="sizePopoverType = ''">
            ...
            <div class="btn" :class="{ 'active': writingBoardModel === 'shape' }" v-tooltip="'形狀'" @click="changeModel('shape')">
          ...
          <Popover placement="top" trigger="manual" :value="sizePopoverType === 'mark'" @hide="sizePopoverType = ''">
            ...
            <div class="btn" :class="{ 'active': writingBoardModel === 'mark' }" v-tooltip="'熒光筆'" @click="changeModel('mark')">
          ...
          <div class="btn" v-tooltip="'清除墨跡'" @click="clearCanvas()">
        ...
        <div class="btn close" v-tooltip="'關閉畫筆'" @click="closeWritingBoard()">
