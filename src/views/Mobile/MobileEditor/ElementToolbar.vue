  ...
  <div class="element-toolbar">
    ...
    <div class="content">
      <div class="style" v-if="activeTab === 'style'">
        ...
        <div class="tip" v-if="!textPropsEnable && !textColorPropsEnable && !fillPropsEnable">暫無可用屬性</div>
      </div>

      <div class="common" v-if="activeTab === 'common'">
        <ButtonGroup class="row">
          <Button style="flex: 1;" @click="copyElement()"><i-icon-park-outline:copy class="icon" /> 複製</Button>
          <Button style="flex: 1;" @click="deleteElement()"><i-icon-park-outline:delete class="icon" /> 刪除</Button>
        </ButtonGroup>
        
        <Divider :margin="20" />

        <ButtonGroup class="row">
          <Button style="flex: 1;" @click="orderElement(handleElement!, ElementOrderCommands.TOP)"><i-icon-park-outline:send-to-back class="icon" /> 置頂</Button>
        ...
        <ButtonGroup class="row">
          <Button style="flex: 1;" @click="alignElementToCanvas(ElementAlignCommands.LEFT)"><i-icon-park-outline:align-left class="icon" /> 左對齊</Button>
          ...
          <Button style="flex: 1;" @click="alignElementToCanvas(ElementAlignCommands.RIGHT)"><i-icon-park-outline:align-right class="icon" /> 右對齊</Button>
        </ButtonGroup>
        <ButtonGroup class="row">
          <Button style="flex: 1;" @click="alignElementToCanvas(ElementAlignCommands.TOP)"><i-icon-park-outline:align-top class="icon" /> 上對齊</Button>
          ...
          <Button style="flex: 1;" @click="alignElementToCanvas(ElementAlignCommands.BOTTOM)"><i-icon-park-outline:align-bottom class="icon" /> 下對齊</Button>
        </ButtonGroup>
      </div>
    </div>
  </div>
